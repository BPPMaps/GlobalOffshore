...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-35.592242, 10.004187, 71.135029, 76.340357], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
...
map.getView().fit([-35.592242, 10.004187, 71.135029, 76.340357], map.getSize());
